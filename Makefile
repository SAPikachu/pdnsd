# $Id: Makefile,v 1.20 2000/06/24 21:44:21 thomas Exp $
#
...
CFLAGS=-g -W -Wchar-subscripts -Wcomment -Wformat -Wimplicit -Wparentheses -Wswitch -Wunused $(STRICT_CF) #-Wmultichar 
...
lex.yy.c lex.inc.h: conf.l.templ config.h
