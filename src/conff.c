...
servparm_t server;
#ifdef ENABLE_IPV4
servparm_t serv_presets={53,C_NONE,120,900,600,"","","","","",0,0,1,1,0,C_INCLUDED,NULL,0,0,{{INADDR_ANY}},{{INADDR_ANY}}};
#else
servparm_t serv_presets={53,C_NONE,120,900,600,"","","","","",0,0,1,1,0,C_INCLUDED,NULL,0,0,{IN6ADDR_ANY_INIT},{IN6ADDR_ANY_INIT}};
#endif
